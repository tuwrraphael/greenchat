...
/***/ "./src/database/greenchat-database.ts":
/*!********************************************!*\
  !*** ./src/database/greenchat-database.ts ***!
  \********************************************/
/*! exports provided: GreenchatDatabase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GreenchatDatabase", function() { return GreenchatDatabase; });
/* harmony import */ var dexie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dexie */ "./node_modules/dexie/dist/dexie.es.js");
/* harmony import */ var _uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../uuid */ "./src/uuid.ts");
...
var GreenchatDatabase = /** @class */ (function (_super) {
    __extends(GreenchatDatabase, _super);
    function GreenchatDatabase(databaseName) {
        ...
        _this.stateMembers = _this.table("stateMembers");
        _this.sources = _this.table("sources");
        _this.userInfo = _this.table("userInfo");
        return _this;
    }
    GreenchatDatabase.prototype.createUser = function (newUserInfo) {
    ...
    GreenchatDatabase.prototype.getUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var userInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.userInfo.get("local")];
                    case 2:
                        userInfo = _a.sent();
                        if (null == userInfo) {
    ...
    GreenchatDatabase.prototype.getUpdatesForRemote = function (remoteClientSources) {
        return __awaiter(this, void 0, void 0, function () {
            var localSources, sourcesWithUpdates, remoteUpdate, _loop_1, this_1, sourcesWithUpdates_1, sourcesWithUpdates_1_1, _a, local, remoteTimestamp, e_1_1;
            var e_1, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.sources.toArray()];
                    case 1:
                        localSources = _c.sent();
                        sourcesWithUpdates = localSources.map(function (local) {
                            var remote = remoteClientSources.find(function (r) { return r.id === local.id; });
                            return {
                                local: local,
                                hasUpdates: !remote || local.latestTimestamp > remote.latestTimestamp,
                                remoteTimestamp: remote ? remote.latestTimestamp : 0
                            };
                        }).filter(function (s) { return s.hasUpdates; });
                        remoteUpdate = {
                            messages: [],
                            sources: sourcesWithUpdates.map(function (_a) {
                                var local = _a.local;
                                return local;
                            })
                        };
                        _loop_1 = function (local, remoteTimestamp) {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this_1.stateMembers.where("[id+sourceId]")
                                            .between([dexie__WEBPACK_IMPORTED_MODULE_0__["default"].minKey, local.id], [dexie__WEBPACK_IMPORTED_MODULE_0__["default"].maxKey, local.id], true, true)
                                            .filter(function (d) { return d.timestamp > remoteTimestamp; })
                                            .each(function (f) {
                    ...
                    case 2:
                        ...
                        sourcesWithUpdates_1 = __values(sourcesWithUpdates), sourcesWithUpdates_1_1 = sourcesWithUpdates_1.next();
                        _c.label = 3;
                    case 3:
                        if (!!sourcesWithUpdates_1_1.done) return [3 /*break*/, 6];
                        _a = sourcesWithUpdates_1_1.value, local = _a.local, remoteTimestamp = _a.remoteTimestamp;
                        return [5 /*yield**/, _loop_1(local, remoteTimestamp)];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
                        sourcesWithUpdates_1_1 = sourcesWithUpdates_1.next();
                        return [3 /*break*/, 3];
                    ...
                    case 8:
                        try {
                            if (sourcesWithUpdates_1_1 && !sourcesWithUpdates_1_1.done && (_b = sourcesWithUpdates_1.return)) _b.call(sourcesWithUpdates_1);
                        }
                        finally { if (e_1) throw e_1.error; }
                        return [7 /*endfinally*/];
                    case 9: return [2 /*return*/, remoteUpdate];
                }
            });
        });
    };
    GreenchatDatabase.prototype.getSources = function () {
        return __awaiter(this, void 0, void 0, function () {
            var localSources;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sources.toArray()];
                    case 1:
                        localSources = _a.sent();
                        return [2 /*return*/, localSources.map(function (v) {
                                return {
                                    id: v.id,
    ...
    GreenchatDatabase.prototype.applyRemoteUpdates = function (update) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transaction("rw", this.stateMembers, function () { return __awaiter(_this, void 0, void 0, function () {
                            var _a, _b, message, stored, e_2_1;
                            var e_2, _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        _d.trys.push([0, 6, 7, 8]);
                                        _a = __values(update.messages), _b = _a.next();
                                        _d.label = 1;
                                    case 1:
                                        if (!!_b.done) return [3 /*break*/, 5];
                                        message = _b.value;
                                        return [4 /*yield*/, this.stateMembers.where(["id+sourceId"])
                                                .equals([message.id, message.sourceId])
                                                .first()];
                                    case 2:
                                        stored = _d.sent();
                                        if (!(!stored || stored.timestamp < message.timestamp)) return [3 /*break*/, 4];
                                        return [4 /*yield*/, this.stateMembers.put({
                                                id: message.id,
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.transaction("rw", this.sources, function () { return __awaiter(_this, void 0, void 0, function () {
                                var _a, _b, source, stored, newTimeStamp, e_3_1;
                                var e_3, _c;
                                return __generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                            _d.trys.push([0, 6, 7, 8]);
                                            _a = __values(update.sources), _b = _a.next();
                                            _d.label = 1;
                                        case 1:
                                            if (!!_b.done) return [3 /*break*/, 5];
                                            source = _b.value;
                                            return [4 /*yield*/, this.sources.get(source.id)];
                                        case 2:
                                            stored = _d.sent();
                                            newTimeStamp = Math.max(source.latestTimestamp, stored ? stored.latestTimestamp : 0);
                                            return [4 /*yield*/, this.sources.put({
                                                    id: source.id,
    ...
    GreenchatDatabase.prototype.hack_addMessage = function (clientId, msg) {
        return __awaiter(this, void 0, void 0, function () {
            var latest, newTs, m;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stateMembers
                            .orderBy("timestamp")
                            .filter(function (v) { return v.sourceId == clientId; })
                            .last()];
                    case 1:
                        latest = _a.sent();
                        newTs = latest ? ++latest.timestamp : 1;
                        m = {
                            id: Object(_uuid__WEBPACK_IMPORTED_MODULE_1__["uuid"])(),
                            sourceId: clientId,
                            content: { msg: msg, timestamp: +new Date() },
                            timestamp: newTs
                        };
                        return [4 /*yield*/, this.stateMembers.put(m)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.sources.put({ id: clientId, latestTimestamp: newTs })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, m];
                }
    ...
    GreenchatDatabase.prototype.hack_getMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.stateMembers.toArray()];
                    case 1: return [2 /*return*/, (_a.sent()).map(function (v) {
                            return {
                                from: v.sourceId,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _database_greenchat_database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./database/greenchat-database */ "./src/database/greenchat-database.ts");
/* harmony import */ var _security_generate_identity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./security/generate-identity */ "./src/security/generate-identity.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = new _database_greenchat_database__WEBPACK_IMPORTED_MODULE_0__["GreenchatDatabase"]("greenchat-db");
                    return [4 /*yield*/, db.getUser()];
                case 1:
                    user = _a.sent();
                    if (!(null == user)) return [3 /*break*/, 3];
                    document.getElementById("splashscreen_status-generating-user").style.display = "block";
                    return [4 /*yield*/, Object(_security_generate_identity__WEBPACK_IMPORTED_MODULE_1__["generateIdentity"])()];
                case 2:
                    user = _a.sent();
                    db.createUser(user);
                    _a.label = 3;
...
/***/ "./src/security/generate-identity.ts":
/*!*******************************************!*\
  !*** ./src/security/generate-identity.ts ***!
  \*******************************************/
/*! exports provided: generateIdentity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateIdentity", function() { return generateIdentity; });
/* harmony import */ var _generate_user_address__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generate-user-address */ "./src/security/generate-user-address.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function generateIdentity() {
    return __awaiter(this, void 0, void 0, function () {
        var encryptionKey, signingKey, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    signingKey = _b.sent();
                    _a = { encryptionKey: encryptionKey, signingKey: signingKey };
                    return [4 /*yield*/, Object(_generate_user_address__WEBPACK_IMPORTED_MODULE_0__["generateUserAddress"])(signingKey)];
                case 3: return [2 /*return*/, (_a.address = _b.sent(), _a)];
            }
        });
    });
}
...
/***/ "./src/security/generate-user-address.ts":
/*!***********************************************!*\
  !*** ./src/security/generate-user-address.ts ***!
  \***********************************************/
/*! exports provided: generateUserAddress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateUserAddress", function() { return generateUserAddress; });
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function generateUserAddress(signingKey) {
    return __awaiter(this, void 0, void 0, function () {
        var exportedPublicKey, _a, modifier, concatenated, digest, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = Uint8Array.bind;
                ...
                case 1:
                    exportedPublicKey = new (_a.apply(Uint8Array, [void 0, _c.sent()]))();
                    modifier = new Uint8Array(16);
                    crypto.getRandomValues(modifier);
                    concatenated = new Uint8Array(modifier.length + exportedPublicKey.length);
                    concatenated.set(modifier);
                    concatenated.set(exportedPublicKey, modifier.length);
                    _b = Uint8Array.bind;
                    return [4 /*yield*/, crypto.subtle.digest("SHA-256", concatenated)];
                case 2:
                    digest = new (_b.apply(Uint8Array, [void 0, _c.sent()]))();
                    console.log(digest.length);
                    return [2 /*return*/, btoa(String.fromCharCode.apply(String, __spread(digest)))];
            }
        });
    });
}
